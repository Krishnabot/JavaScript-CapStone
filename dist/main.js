...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/*   const fetchMeal = async () => {\r\n    const popupsMeals = (meals.idMeal) => { */\r\n\r\n      const popupData = (id) => {\r\n      const MealList2 = document.querySelector('.cards');\r\n      console.log(MealList2);\r\n      console.log(id);\r\n      displayData();\r\n      const displayData = async () => {\r\n      /* const gameUrl = `www.themealdb.com/api/json/v1/1/lookup.php?i=52995`;\r\n      const result = await fetch(`www.themealdb.com/api/json/v1/1/lookup.php?i=52995`);\r\n      const data = await result.json(); */\r\n      console.log('data');\r\n    };\r\n      \r\n        const newMeal = document.createElement('div');\r\n        newMeal.classList.add('meal-container2');\r\n        newMeal.id = `container-${data.idMeal}`;\r\n        newMeal.innerHTML = ` \r\n        <div class=\"meal-card\">\r\n          <div class =\"meal-img\">\r\n            <img src=\"${data.strMealThumb}\" alt=\"${data.strMeal}\">\r\n          </div>\r\n          <div class=\"meal-info\">\r\n            <h2 class=\"meal-name\">${data.strMeal}</h2>\r\n            <p class=\"Description\"><strong>Amazing food</strong></p>\r\n            <h3 class=\"subtitle1\">Comments</h3>\r\n            <div class=\"meal-reaction\">\r\n            <input class=\"Name\" type=\"text\" placeholder=\"Your name\">\r\n            <input class=\"Insights\" type=\"text\" placeholder=\"Your insights\">\r\n            <button class =\"comment2\" data=\"${data.idMeal}}\">Comment</button>\r\n            </div>\r\n            </div>\r\n            </div>\r\n  `;\r\n\r\n        MealList2.appendChild(newMeal);    \r\n    };\r\n\r\n\r\n    /* const fetchURL = 'https://www.themealdb.com/api/json/v1/1/filter.php?a=american';\r\n    const meals = await fetch(fetchURL)\r\n      .then((response) => response.json())\r\n      .then((data) => data.meals);\r\n    popupsMeals(meals);\r\n    const MealCount = document.querySelector('.menuCount');\r\n    MealCount.innerHTML = `${meals.length}`;\r\n  }; */\r\n\r\n/* fetchMeal(); */\r\n\r\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (popupData);\r\n\n\n//# sourceURL=webpack://to-do-list/./src/pop-up.js?");
